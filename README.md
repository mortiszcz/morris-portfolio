...
The site is static and requires no build step. Cloudflare Workers serves the repository root through `wrangler.jsonc`. The homepage motion reel is a deployment copy encoded at 1080p with transparency; the 1440p source remains in the local master archive.
